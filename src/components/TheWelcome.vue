...
import Icon, { Icons } from './icons/Icon.vue';

const vIcon0 = ref(Icons.Documentation);
</script>

<template>
  <WelcomeItem>
    <template #icon>
      <Icon v-model:icon="vIcon0" :title="vIcon0" />
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <Icon v-model:icon="Icons.Tooling" :title="Icons.Tooling" />
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <Icon v-model:icon="Icons.Ecosystem" :title="Icons.Ecosystem" />
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <Icon v-model:icon="Icons.Community" :title="Icons.Community" />
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <Icon v-model:icon="Icons.Support" :title="Icons.Support" />
    </template>
